...
def tiny_synthetic_ot_config() -> dict[str, Any]:
    return {
        ...
        "generator_init_std": 0.1,
        "strong_convexity": 0.1,
        "calibration_samples": 128,
        "target_rms_multiplier": 2.0,
        "seed": 7,
    }
    ...
    def build(name: str) -> dict[str, Any]:
        configs = {
            ...
            "monge_map": {
                ...
                "potential_lr": 1.0e-3,
                "quadratic_scale": 0.5,
                "use_c_concave_parameterization": False,
                "potential": {
                    "kind": "mlp",
                    "hidden_dims": [8, 8],
                    "activation": "silu",
            ...
            "otm": {
                ...
                "potential_lr": 1.0e-3,
                "use_c_concave_parameterization": False,
                "transport_l2_weight": 0.0,
                "dot_reward_scale": 0.5,
                "gradient_optimality_weight": 1.0,
                "potential": {
                    "kind": "mlp",
                    "hidden_dims": [8, 8],
                    "activation": "silu",
